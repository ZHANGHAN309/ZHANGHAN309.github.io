...
Lambda 表达式是一个简洁的语法，用于创建匿名函数，常用于 LINQ 查询和委托
语法格式为(参数)=>表达式/代码块
...
delegate 是 C# 2.0 引入的特性，Lambda 是 C# 3.0 引入的特性，相比之下 Lambda 更简单更灵活
...
LINQ 是在 C# 3.0 引入的，简单来说就是用简单统一的语法，查询和操作各种数据源
